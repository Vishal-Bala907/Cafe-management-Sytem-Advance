...
public class AddFirstManager implements Initializable {
	private String[] empTypes = { "Manager"};
	@FXML
	...
	void done(ActionEvent event) {
		...
		if (saveData > 0) {
			...
			new AlertClass().showAlert(Alert.AlertType.CONFIRMATION, "Done", "Manager Added Successfully");
